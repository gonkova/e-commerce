      ...
      <div className="txt-medium">
        {gift_cards.length > 0 && (
          <div className="flex flex-col mb-4">
            <Heading className="txt-medium">Използвани подаръчни карти:</Heading>
            {gift_cards?.map((gc) => (
              <div
              ...
              >
                ...
                >
                  <Trash size={14} />
                  <span className="sr-only">Премахни подаръчната карта от поръчката</span>
                </button>
              </div>
            ))}
          </div>
        ...
        {appliedDiscount ? (
          <div className="w-full flex items-center">
            <div className="flex flex-col w-full">
              <Heading className="txt-medium">Отстъпката е приложена:</Heading>
              <div
              ...
              >
                ...
                >
                  ...
                  Премахни кода за отстъпка от поръчката
                  </span>
                </button>
              </div>
            </div>
          ...
          <form action={formAction} className="w-full">
            <Label className="flex gap-x-1 my-2 items-center">
              ...
              >
               Добавете карта за подарък или код за отстъпка
              </button>
