...
const ShowAll = () => {
  ...
  if (hits.length === 0) {
    return (
      ...
      >
        <Text>Не бяха намерени резултати.</Text>
      </Container>
    )
  }
  ...
  return (
    <Container className="flex sm:flex-col small:flex-row gap-2 justify-center items-center h-fit py-4 small:py-2">
      <Text>Показване на първите {width > 640 ? 6 : 3} резултати.</Text>
      <InteractiveLink href={`/results/${query}`}>Преглед на всички</InteractiveLink>
    </Container>
  )
}
