    ...
    <div data-testid="overview-page-wrapper">
      <div className="hidden small:block">
        <div className="text-xl-semi flex justify-between items-center mb-4">
          <span data-testid="welcome-message" data-value={customer?.first_name}>Здравей {customer?.first_name}</span>
          ...
          <div className="flex flex-col gap-y-4 h-full col-span-1 row-span-2 flex-1">
            <div className="flex items-start gap-x-16 mb-6">
              <div className="flex flex-col gap-y-4">
                <h3 className="text-large-semi">Профил</h3>
              ...
              <div className="flex flex-col gap-y-4">
                <h3 className="text-large-semi">Адрес</h3>
                <div className="flex items-end gap-x-2">
            ...
            <div className="flex flex-col gap-y-4">
              <div className="flex items-center gap-x-2">
                <h3 className="text-large-semi">Последни поръчки</h3>
              </div>
              <ul className="flex flex-col gap-y-4" data-testid="orders-wrapper">
                {orders && orders.length > 0 ? (
                        ...
                        >
                          <Container className="bg-gray-50 flex justify-between items-center p-4">
                            <div className="grid grid-cols-3 grid-rows-2 text-small-regular gap-x-4 flex-1">
                              <span className="font-semibold">Дата на разполагане</span>
                            ...
                            <button className="flex items-center justify-between" data-testid="open-order-button">
                              ...
                              Отиди към поръчка #{order.display_id}
                              </span>
                  ...
                  <span data-testid="no-orders-message">Няма последни поръчки</span>
                )}
              </ul>
            </div>
          </div>
